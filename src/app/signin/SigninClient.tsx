  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      <div className="wood-card rounded-2xl p-8 shadow-lg">
        ...
        {/* メールログイン */}
        {emailSent ? (
          <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-4 text-center">
            <p className="text-sm font-medium text-amber-950">メールを送信しました</p>
          ...
          <form onSubmit={handleEmailSignin} className="mb-5">
            ...
            <button
              ...
              className="mt-3 w-full rounded-xl bg-amber-900 py-3 text-sm font-medium text-white shadow-sm transition-all hover:bg-amber-800 disabled:opacity-50"
            >
