...
-- CreateIndex
CREATE INDEX "PlayRecord_gameId_idx" ON "PlayRecord"("gameId");
...
-- AddForeignKey
ALTER TABLE "PlayRecord" ADD CONSTRAINT "PlayRecord_gameId_fkey" FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
